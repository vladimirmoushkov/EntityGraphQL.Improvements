...
namespace EntityGraphQL.Compiler
{
    ...
    {
        public static readonly Regex QuotesBegin = new("^ *\\\"", RegexOptions.IgnoreCase);
        public static readonly Regex QuotesEnd = new("\\\".*$", RegexOptions.IgnoreCase);
        ...
        public override Expression? VisitString(EntityQLParser.StringContext context)
        {
            ...
            // bail out the default parser as it does not support cyrillic
            string value = context.GetText();
            value = QuotesBegin.Replace(value, "");
            value = QuotesEnd.Replace(value, "");
